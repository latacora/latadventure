...
latadventure.rooms.greet_lvh = (function latadventure$rooms$greet_lvh(game_state__23555__auto__){
if(cljs.core.truth_(advenjure.dialogs.event_QMARK_.call(null,new cljs.core.Keyword(null,"knows-lvh","knows-lvh",-207472860)).call(null,game_state__23555__auto__))){
return (function (game_state__23501__auto__){
return advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"ME","Hi \"ell vee aitch\"!");
}).call(null,game_state__23555__auto__);
} else {
return (function (game_state__23501__auto__){
return advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"ME","Uh, hello?");
}).call(null,game_state__23555__auto__);
}
});
latadventure.rooms.lvh_response = (function latadventure$rooms$lvh_response(game_state__23545__auto__){
var selected__23546__auto__ = cljs.core.get.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (game_state__23501__auto__){
return advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"LVH","Hm?");
}),(function (game_state__23501__auto__){
return advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"LVH","What do you want?");
}),(function (game_state__23501__auto__){
return advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"LVH","I'm busy.");
})], null),cljs.core.rand_int.call(null,3));
return selected__23546__auto__.call(null,game_state__23545__auto__);
});
...
latadventure.rooms.lvh_dialog_options = (function latadventure$rooms$lvh_dialog_options(game_state__23539__auto__){
return advenjure.dialogs.execute_optional.call(null,game_state__23539__auto__,(function (){var x__21289__auto__ = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),"opt23685",new cljs.core.Keyword(null,"title","title",636505583),"Who are you?",new cljs.core.Keyword(null,"dialog","dialog",1415150135),(function (game_state__23501__auto__){
return advenjure.dialogs.set_event.call(null,new cljs.core.Keyword(null,"knows-lvh","knows-lvh",-207472860)).call(null,advenjure.dialogs.print_dialog.call(null,advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"ME","Who are you?"),"LVH","I am \"ell vee aitch\". Who are you?"));
...
return cljs.core._conj.call(null,(function (){var x__21289__auto____$1 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),"opt23686",new cljs.core.Keyword(null,"title","title",636505583),"Why are you here?",new cljs.core.Keyword(null,"dialog","dialog",1415150135),((function (x__21289__auto__){
return (function (game_state__23501__auto__){
return advenjure.dialogs.print_dialog.call(null,advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"ME","Why are you here?"),"LVH","I work here, dude.");
});})(x__21289__auto__))
...
return (function (gs__23518__auto__){
return true;
});})(x__21289__auto__))
], null);
return cljs.core._conj.call(null,(function (){var x__21289__auto____$2 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),"opt23687",new cljs.core.Keyword(null,"title","title",636505583),"Would you like this bottle?",new cljs.core.Keyword(null,"dialog","dialog",1415150135),((function (x__21289__auto____$1,x__21289__auto__){
return (function (game_state__23501__auto__){
return latadventure.rooms.take_bottle.call(null,advenjure.dialogs.print_dialog.call(null,advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"ME","Would you like this bottle?"),"LVH","Sure, might as well. What a fucking day, man. Fucking \"vee-ruh-coat\". Even with the form letters, it's a mess."));
...
return cljs.core._conj.call(null,(function (){var x__21289__auto____$3 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),"opt23688",new cljs.core.Keyword(null,"title","title",636505583),"Have you read this paper?",new cljs.core.Keyword(null,"dialog","dialog",1415150135),((function (x__21289__auto____$2,x__21289__auto____$1,x__21289__auto__){
return (function (game_state__23501__auto__){
return latadventure.rooms.take_paper.call(null,advenjure.dialogs.print_dialog.call(null,advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"ME","Have you read this paper?"),"LVH","Yeah. I should read it again though. It's a good paper."));
...
return cljs.core._conj.call(null,(function (){var x__21289__auto____$4 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),"opt23689",new cljs.core.Keyword(null,"title","title",636505583),"Maybe you should go back to your tower?",new cljs.core.Keyword(null,"dialog","dialog",1415150135),((function (x__21289__auto____$3,x__21289__auto____$2,x__21289__auto____$1,x__21289__auto__){
return (function (game_state__23501__auto__){
return latadventure.rooms.lvh_leaves.call(null,advenjure.dialogs.print_dialog.call(null,advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"ME","Sounds like you had a long day, man. Maybe you should go back to your tower?"),"LVH","Yeah. You're right. See ya."));
...
return cljs.core._conj.call(null,(function (){var x__21289__auto____$5 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"id","id",-1388402092),"opt23690",new cljs.core.Keyword(null,"title","title",636505583),"Bye.",new cljs.core.Keyword(null,"dialog","dialog",1415150135),((function (x__21289__auto____$4,x__21289__auto____$3,x__21289__auto____$2,x__21289__auto____$1,x__21289__auto__){
return (function (game_state__23501__auto__){
return advenjure.dialogs.print_dialog.call(null,advenjure.dialogs.print_dialog.call(null,game_state__23501__auto__,"ME","Bye."),"NPC","See you.");
...
latadventure.rooms.lvh_dialog = (function latadventure$rooms$lvh_dialog(game_state__23501__auto__){
return latadventure.rooms.lvh_dialog_options.call(null,latadventure.rooms.lvh_response.call(null,latadventure.rooms.greet_lvh.call(null,game_state__23501__auto__)));
});
...
//# sourceMappingURL=rooms.js.map?rel=1522175327928